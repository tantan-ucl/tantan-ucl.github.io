...
# Journal Paper
* **Tan Tan***, Grant Mills, Eleni Papadonikolaki, Baofeng Li, Jing Hung (2022). "Digital-enabled Design for Manufacture and Assembly (DfMA) in Offsite Construction: A Modularity Perspective for the Product and Process Integration". <i>Architectural Engineering and Design Management</i>. In Press.
* Zigeng Fang, **Tan Tan**, J Yan, Qiuchen Lu*, Michael Pitt, Sean Hanna (2022). An Automated Portfolio-based Strategic Asset Management Approach Based on Deep Neural Image Classification. <i>Automation in Construction</i>. In Press.
