...
# 会议论文:
9.	**Tan, T***., Papadonikolaki, E., Mills, G., Chen, J., Zhang, Z., & Chen, K. (2021). BIM-enabled Sustainability Assessment of Design for Manufacture and Assembly. In 38th International Symposium on Automation and Robotics in Construction (ISARC 2021). [基于BIM的面向制造与装配式设计的可持续性评估] (EI检索)
10.	**Tan, T**., Fang, Z*., Zheng, Y., & Yang, Y. (2021). Health Building Information Modeling (HBIM)-based facility management: a conceptual framework. In 26th International Conference on Advancement of Construction Management and Real Estate (CRIOCM 2021). [基于健康建筑信息模型 (HBIM) 的设施管理：概念框架]
11.	Liu, Y., Chen, K., Ma, L., Tang, S., & **Tan, T**. (2021).Transforming data into decision making: A spotlight review of construction digital twin. In International Conference on Construction and Real Estate Management (ICCREM 2021). [将数据转化为决策：建筑数字孪生的焦点回顾] (EI检索)
